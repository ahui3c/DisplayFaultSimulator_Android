# Display Fault Simulator 1.9.0

## 繁體中文

- 重新設計主設定畫面，以更精簡的現代化配置提高操作效率
- 修正 Android 15／16 設定介面與狀態列、瀏海及導覽列重疊
- 新增五種適合折疊機的左側破裂預設：左上角、左下角、鉸鏈髮絲裂、多重撞擊及重度碎裂
- 移除規則半透明三角碎片，改為貼著螢幕邊緣生長的不規則深黑面板破損與液晶滲漏
- 保留全螢幕覆蓋、硬體座標固定及觸控完全穿透

## English

- Redesigned the main settings screen with a more compact modern layout
